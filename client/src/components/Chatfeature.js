...
const Chatfeature = () => {
  ...
  return (
    <div className='chatfeaturebar'>
      ...
      <div className='chatfeature-chatname'>
        <span className='chat-profile'><img src={presentChat.profilePic?LogoUrl(presentChat.profilePic):LogoUrl("/public/groupPictures/favicon.png")} /></span>
        <span className='chatname'>{presentChat.chatname ? presentChat.chatname : "Whatsapp"}</span>
      </div>
